...
pallettes = [
    ...
    ['#EBC2AC','#FFFCFA','#E6D4CA','#689997','#CAE6E4'],
    ['#F2059F','#BF04A0','#0477BF','#F2B705','#F2F2F2'],
    ['#AAB1BF','#C7CFD9','#D8E6F2','#A68A80','#BFB9B8'],
    ['#5D8C87','#707366','#A4A698','#BDBFB0','#D7D9C7'],
    ['#73202F','#778A8C','#F28157','#F21905','#730202'],
    ['#3D203D','#5C2C45','#9E909B','#D1BCB5','#DEBCA9'],

    ['#020659','#010440','#9498F2','#BF9460','#D9D9D9'],
    ['#7B8081','#EFF1F2','#2C4B5D','#99A9B2','#1B2325'],
    ['#A446A6','#794D8C','#AE95BF','#2D1F40','#0D0D0D'],
]
